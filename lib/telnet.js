...
/*
  https://tools.ietf.org/html/rfc884
   The following is an example of use of the option:
      ...
      Host1: IAC DO TERMINAL-TYPE - NOTE: Already sent by server.

      Host2: IAC WILL TERMINAL-TYPE - NOTE: Already sent by client.
  ...
  NOTE: After WILL TERMINAL-TYPE, we need to send
  new Buffer([
    COMMANDS.IAC,
    COMMANDS.SB,
